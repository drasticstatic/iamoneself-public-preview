...
reuse. Its [public preview](https://github.com/drasticstatic/iamoneself-public-preview)
is available under the [MIT License](https://github.com/drasticstatic/iamoneself-public-preview/blob/main/LICENSE).
